/*
  ...
  - The values [BLOCKED] on the enum `RelationshipStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RelationshipStatus_new" AS ENUM ('FRIEND', 'BLOCKED_USER_1', 'BLOCKED_USER_2', 'BLOCKED_BOTH', 'PENDING');
